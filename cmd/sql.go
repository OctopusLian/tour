...
import (
	...
	"github.com/programming-book-practice/tour/internal/sql2strcut"

	"github.com/spf13/cobra"
)

var username string  //数据库的账号
var password string  //数据库的密码
var host string      //数据库的HOST
var charset string   //数据库的编码
var dbType string    //数据库的数据库类型
var dbName string    //数据库的名称
var tableName string //数据库的表名称
